          ...
          <div className="md:grid grid-cols-2">
            ...
            <div className="my-4">
              <select
                ...
                className="bg-gray-50 text-black text-sm shadow-md rounded-lg block md:w-5/6 w-full p-2 disabled:cursor-not-allowed"
            ...
            {/* <div className="my-4">
              <input
                ...
                id=""
              />
              <label htmlFor="countries" className="block text-sm text-black mt-1">
                Enter amount
              </label>
            </div> */}

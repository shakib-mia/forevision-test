        ...
        <form onSubmit={handleSubmit}>
              ...
              <div className="bg-gray-50 text-black text-sm shadow-md rounded-lg block md:w-5/6 w-full p-2">
                ...
                >
                  <p className="overflow-hidden mr-2 h-3">
                    {file.name ? file.name.split(".")[0] : "File name"}
                  </p>
                  <svg
                    width="14"
                    height="14"
          ...
          <div className="flex justify-between">
            <div className="my-4">
              <input
                type="number"
                className="bg-gray-50 text-black text-sm shadow-md rounded-lg block w-full p-2"
                placeholder="IGST Number"
                name="igst"
                id=""
              />
              <label for="countries" class="block text-sm text-black mt-1">
                For artist outside of W.B
              </label>
            </div>
            <div className="my-4">
              <input
              ...
              />
              <label for="countries" class="block text-sm text-black mt-1">
                For artist of West Bengal , India
              </label>
            </div>
            <div className="my-4">
              <input

  ...
  return (
    <div className='w-screen h-screen fixed top-0 left-0 z-[9999] flex justify-center items-center backdrop-blur-[1px]'>
      <div className='md:w-3/5 w-11/12 h-[80vh] relative overflow-x-visible rounded-2xl overflow-y-auto p-3 px-5' style={{ backgroundColor: '#ffffffd9' }}>
        <button onClick={() => setShowGstModal(false)} className='absolute text-interactive-light-destructive-focus text-heading-3 top-2 right-2 opacity-50'>
        ...
        <div className='mt-4'>
          <p className='md:ml-3 mb-3 text-heading-6-bold title text-grey-dark my-1'>Revenue Withdraw gst</p>
        ...
        <form className=''>
          <div className='md:grid grid-cols-2'>
            <div className='my-4'>
              ...
              <label for="countries" class="block text-sm text-black mt-1">Enter your GST number</label>
            </div>
            <div className='my-4'>
              <div className='bg-gray-50 text-black text-sm shadow-md rounded-lg block md:w-5/6 w-full p-2'>
                ...
                <input type="file" onChange={e => setFileName(e.target.value)} name="gstCertificate" id="files" style={{ display: "none" }} />
              </div>
              <label for="countries" class="block text-sm text-black mt-1">Upload your GST Certificate</label>
            </div>
          </div>
          <div className='flex justify-between'>
            <div className='my-4'>
              <input type="number" className='bg-gray-50 text-black text-sm shadow-md rounded-lg block w-full p-2' placeholder='IGST Number' name="igst" id="" />
              <label for="countries" class="block text-sm text-black mt-1">For artist outside of W.B</label>
            </div>
            <div className='my-4'>
              <input type="number" className='bg-gray-50 text-black text-sm shadow-md rounded-lg block w-full p-2' placeholder='SGST' name="sgst" id="" />
              <label for="countries" class="block text-sm text-black mt-1">For artist of West Bengal , India</label>
            </div>
            <div className='my-4'>
              <input type="number" className='bg-gray-50 text-black text-sm shadow-md rounded-lg block w-full p-2' placeholder='CGST' name="cgst" id="" />
              <label for="countries" class="block text-sm text-black mt-1">For artist of West Bengal , India</label>
            </div>
          </div>

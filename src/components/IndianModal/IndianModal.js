  ...
  const handleSubmit = (e) => {
    ...
    Promise.all(uploadPromises)
      .then((responses) => {
        ...
        // Assuming setAadharUrl, setPanUrl, and setCancelledChequeUrl are functions that update your state or handle the URLs somehow
        setAadharUrl(aadharUrl);
        setPanUrl(panUrl);
        setCancelledChequeUrl(cancelledChequeUrl);

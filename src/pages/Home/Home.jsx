...
const Home = () => {
  return (
    <div className="bg-grey-dark p-5 rounded-[20px] m-4 ml-7">
      <div className="flex justify-between space-x-5">
        <div className="w-1/3 bg-white p-4 rounded-2xl">
          ...
          <div className="mt-4">
            <div className="flex gap-3">
              <div className="flex gap-2 items-center">
                <h5 className="text-heading-5">
                  John Doe
                  <div className="border border-grey-dark"></div>
                </h5>
            ...
            <p className="text-grey-dark my-1">99 Followers</p>
        ...
        <div className="w-1/3 bg-white px-4 py-6 rounded-2xl relative overflow-hidden">
          <img src={accountBg} className="absolute top-0 left-0 z-0 w-full" alt="" />
          <div className="absolute z-10 left-0 w-full">
            <h4 className="text-heading-4-bold ml-4 text-grey">Account <br /> Balance</h4>
            <h4 className="text-heading-4-bold ml-4 mt-4 mb-5 text-grey-dark">20.69989967</h4>
      ...
      <div className="flex mt-5 w-full gap-5">
        <div className="w-1/2 bg-white rounded-2xl p-4 h-[392px]"></div>
        <div className="w-1/2 bg-white rounded-2xl p-4 h-[392px]"></div>
      </div>
    </div>
  );

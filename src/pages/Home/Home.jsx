      ...
      <div className="grid grid-cols-1 2xl:grid-cols-3 justify-between space-y-4 2xl:space-y-0 2xl:space-x-5">
        <div className="bg-white p-0 2xl:p-4 rounded-2xl">
          ...
          <div className="mt-4">
            ...
            <p className="text-grey-dark my-1 text-center 2xl:text-left">
              99 Followers
            </p>
            <p className="text-button text-grey-dark uppercase mb-1 text-center 2xl:text-left">
              Rock is my way of exploring music{" "}
            </p>
            <p className="text-grey-dark text-subtitle-2 text-center 2xl:text-left">
        ...
        <div className="bg-grey-light 2xl:bg-white px-4 py-2 2xl:py-4 rounded-2xl relative overflow-hidden h-[392px] 2xl:h-auto">
          ...
          <div className="absolute z-10 left-0 w-full">
            <h4 className="text-heading-4-bold ml-5 2xl:ml-4 text-white 2xl:text-grey">
              Account <br /> Balance
            </h4>
            <h4 className="text-heading-4-bold ml-5 2xl:ml-4 mt-5 2xl:mt-4 mb-5 text-grey-dark">
              20.69989967
            </h4>
            <div className="flex justify-center 2xl:justify-start 2xl:ml-4">
              <Button disabled={true} text="Request Withdraw"></Button>
            </div>
          </div>
        </div>

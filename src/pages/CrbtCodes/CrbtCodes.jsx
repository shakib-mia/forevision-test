...
const CrbtCodes = () => {
  ...
  return (
    <div className="xl:w-10/12 mx-auto mt-7 pb-7 p-3 shadow-xl rounded-lg text-grey-dark">
      <h1 className="text-heading-3-bold mb-2">CRBT Codes</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
        ...
        >
          ...
          <article>
            ...
            <p className="mt-2">
              In ForeVision Digital's case, your CRBT-related plans (ForeVision
            ...
            <h5 className="text-heading-5-bold mt-4">
              Note for Artists via ForeVision Digital:
            </h5>
            <p className="py-1">
              Artists and distributors can submit their content for caller tune
              services via ForeVision CRBT, ForeVision CRBT+, ForeVision Album
